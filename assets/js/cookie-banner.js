(function(){
  ...
  function show(){
    ...
    banner.innerHTML = '<div class="cookie-banner__inner"><div class="cookie-banner__copy"><p class="cookie-banner__title">We use cookies to improve your visit.</p><p class="cookie-banner__text">Roof-M-All uses basic cookies and similar tools to keep the site working and understand what homeowners find useful. Read our <a href="'+ privacyPath +'">Privacy Policy</a>.</p></div><div class="cookie-banner__actions"><button class="cookie-banner__button cookie-banner__button--decline" type="button" data-cookie-choice="declined">Decline</button><button class="cookie-banner__button cookie-banner__button--accept" type="button" data-cookie-choice="accepted">Accept</button></div></div>';
